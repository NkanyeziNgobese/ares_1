...
- `PROJECT_STAGE_SUMMARY.md` - Why this file matters: condensed "where we are" and "what's next" snapshot.
- `FLOW_ANCHOR.md` - Why this file matters: ASCII pipeline anchor, status enum, override metrics.
- `MANIFEST.json` - Why this file matters: index of pack contents with sizes and timestamps.
- `UPLOAD_CHECKLIST.md` - Why this file matters: single checklist for upload readiness.
